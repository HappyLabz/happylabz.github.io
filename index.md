...
<h1 class="header"><span style="color: #167816;">2.57 %</span></h1>
</div>
...
<div class="my-data px-3 my-5 markdown-body">
    ...
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #b91c1c;">-3.94 (-2.08%)</span></b> as of close<br>Feb 02 2024</li>
    ...
    <div class="box gray atUpperPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">16.61 (10.70%)</span></b> as of close<br>Feb 02 2024</li>
    ...
    <div class="box red" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">7.44 (1.84%)</span></b> as of close<br>Feb 02 2024</li>
    ...
    <div class="box gray" onclick="location.href='{% link TSLA.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #b91c1c;">-60.57 (-24.38%)</span></b> as of close<br>Feb 02 2024</li>
    ...
    <div class="box red" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">5.15 (1.05%)</span></b> as of close<br>Feb 02 2024</li>
