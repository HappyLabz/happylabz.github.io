...
<div class="my-data px-3 my-5 markdown-body">
    ...
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">37.88 (25.96%)</span></b> as of close<br>Jun 12 2023</li>
        </ul>
    </div>
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        <h2 id="amzn"><a href="{% link navigation/blocked.md %}">AMZN</a></h2>
        <ul>
            <li>LAST: <b><span style="color: #b91c1c;">Short</span></b> Jun 08 2023 15:00 PST</li>
            <li>DELTA: <b><span style="color: #167816;">2.32 (1.87%)</span></b> as of close<br>Jun 12 2023</li>
        </ul>
    </div>
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        <h2 id="msft"><a href="{% link navigation/blocked.md %}">MSFT</a></h2>
        <ul>
            <li>LAST: <b><span style="color: #b91c1c;">Short</span></b> Jun 07 2023 15:00 PST</li>
            <li>DELTA: <b><span style="color: #167816;">8.47 (2.62%)</span></b> as of close<br>Jun 12 2023</li>
        </ul>
    </div>
    <div class="box gray" onclick="location.href='{% link TSLA.md %}';">
        <h2 id="tsla"><a href="{% link TSLA.md %}">TSLA <span style="color:#0369a1;">&bigstar;</span><span style="color:#0369a1;">&bigstar;</span></a></h2>
        <ul>
            <li>LAST: <b><span style="color: #167816;">Long</span></b> Apr 24 2023 15:00 PST</li>
            <li>DELTA: <b><span style="color: #167816;">87.28 (53.69%)</span></b> as of close<br>Jun 12 2023</li>
        </ul>
    </div>
    <div class="box gray atUpperPriceLine atLowerPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">42.07 (10.74%)</span></b> as of close<br>Jun 12 2023</li>
        </ul>
    </div>
