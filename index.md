...
<div class="my-data px-3 my-5 markdown-body">
    ...
    <div class="box green atUpperPriceLine atLowerPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        <h2 id="aapl"><a href="{% link navigation/blocked.md %}">AAPL</a></h2>
        <ul>
            <li>DAY: <b><span style="color: #167816;">Long</span></b> at 170.29 as of close <br>Oct 30 2023</li>
            <li>DELTA: <b><span style="color: #b91c1c;">0.00 (0.00%)</span></b> as of close<br>Oct 30 2023</li>
    ...
    <div class="box gray atUpperPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #b91c1c;">-4.92 (-3.57%)</span></b> as of close<br>Oct 30 2023</li>
    ...
    <div class="box gray atUpperPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">21.56 (6.83%)</span></b> as of close<br>Oct 30 2023</li>
    ...
    <div class="box gray atLowerPriceLine" onclick="location.href='{% link TSLA.md %}';">
        ...
        <ul>
            <li>DAY: <b><span style="color: #167816;">Long</span></b> at 212.08 as of close <br>Oct 23 2023</li>
            <li>DELTA: <b><span style="color: #b91c1c;">-14.72 (-6.94%)</span></b> as of close<br>Oct 30 2023</li>
    ...
    <div class="box gray atLowerPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #b91c1c;">-36.90 (-8.15%)</span></b> as of close<br>Oct 30 2023</li>
