...
<h1 class="header"><span style="color: #b91c1c;">-1.46 %</span></h1>
</div>
...
<div class="my-data px-3 my-5 markdown-body">
    ...
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #b91c1c;">-7.16 (-3.77%)</span></b> as of close<br>Feb 27 2024</li>
    ...
    <div class="box gray atUpperPriceLine atLowerPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">18.34 (11.82%)</span></b> as of close<br>Feb 27 2024</li>
    ...
    <div class="box gray atLowerPriceLine" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">3.70 (0.92%)</span></b> as of close<br>Feb 27 2024</li>
    ...
    <div class="box gray" onclick="location.href='{% link TSLA.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">8.14 (4.25%)</span></b> as of close<br>Feb 27 2024</li>
    ...
    <div class="box gray" onclick="location.href='{% link navigation/blocked.md %}';">
        ...
        <ul>
            ...
            <li>DELTA: <b><span style="color: #167816;">12.85 (2.60%)</span></b> as of close<br>Feb 27 2024</li>
